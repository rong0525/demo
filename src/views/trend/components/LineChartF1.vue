...
export default {
  ...
  methods: {
    ...
    getTrend(){
      ...
      this.option.series[0].data[2]=Math.floor(this.option.series[0].data[2]-this.option.series[0].data[1]*0.3)
      this.option.series[0].data[3]=Math.floor(this.option.series[0].data[2]+this.option.series[0].data[1]*0.2)
      // console.log(this.option.series[0].data)
      for(let i=0;i<7;i++){
    ...
    axios.get(`http://localhost:9292/getDoqChange`) 
      ...
      this.option.series[1].data[1]=Math.floor(this.option.series[1].data[1]-this.option.series[1].data[0]*0.8)
      this.option.series[1].data[4]=Math.floor(this.option.series[1].data[3]+this.option.series[1].data[1]*0.3)
      this.option.series[1].data[0]=Math.floor(this.option.series[1].data[0]*0.1)
      for(let i=0;i<7;i++){
    ...
    axios.get(`http://localhost:9292/getDotChange`) 
      ...
      this.option.series[2].data[3]=Math.floor(this.option.series[2].data[2]+this.option.series[2].data[0]*0.18)
      this.option.series[2].data[4]=Math.floor(this.option.series[2].data[3]+this.option.series[2].data[0]*0.9)
      this.option.series[2].data[0]=Math.floor(this.option.series[2].data[0]*0.1)
      for(let i=0;i<7;i++){
