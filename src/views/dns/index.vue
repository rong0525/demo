<template>
  <div class="app-container">  
    <el-row >
    <el-col :span="2">
    <el-button type="primary" size="small">开启主动探测</el-button>
    </el-col>
    <el-col :span="4">
      <h6 style="margin-top:10px">更新时间: 2024-6-25</h6>
    </el-col>
    </el-row>
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row style="margin-top:20px">
